/* The following code was generated by JFlex 1.4.3 on 22/10/13 01:15 PM */
 ...
 * on 22/10/13 01:15 PM from the specification file
  ...
  public java_cup.runtime.Symbol next_token() throws java.io.IOException {
    ...
    while (true) {
      ...
      switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
        case 36: 
          { return symbol(PROGRAM, new String("["+ getLinea() + ":" + getColumna() + "] -> " +  yytext()));
          }
        case 37: break;
        case 12: 
        ...
        case 39: break;
        case 33: 
          { return symbol(DO, new String("["+ getLinea() + ":" + getColumna() + "] -> " +  yytext()));
          }
        case 40: break;
        case 10: 
        ...
        case 42: break;
        case 23: 
          { return symbol(IF, new String("["+ getLinea() + ":" + getColumna() + "] -> " +  yytext()));
          }
        case 43: break;
        case 3: 
          { return symbol(ID, new String("["+ getLinea() + ":" + getColumna() + "] -> " +  yytext()));
          }
        case 44: break;
        case 28: 
          { return symbol(MOD, new String("["+ getLinea() + ":" + getColumna() + "] -> " +  yytext()));
          }
        case 45: break;
        case 25: 
        ...
        case 47: break;
        case 35: 
          { return symbol(BOOLEAN, new String("["+ getLinea() + ":" + getColumna() + "] -> " +  yytext()));
          }
        case 48: break;
        case 6: 
        ...
        case 56: break;
        case 19: 
          { return symbol(OR, new String("["+ getLinea() + ":" + getColumna() + "] -> " +  yytext()));
          }
        case 57: break;
        case 24: 
        ...
        case 58: break;
        case 32: 
          { return symbol(WHILE, new String("["+ getLinea() + ":" + getColumna() + "] -> " +  yytext()));
          }
        case 59: break;
        case 30: 
          { return symbol(ELSE, new String("["+ getLinea() + ":" + getColumna() + "] -> " +  yytext()));
          }
        case 60: break;
        case 14: 
        ...
        case 61: break;
        case 18: 
          { return symbol(AND, new String("["+ getLinea() + ":" + getColumna() + "] -> " +  yytext()));
          }
        case 62: break;
        case 11: 
        ...
        case 65: break;
        case 31: 
          { return symbol(FOR, new String("["+ getLinea() + ":" + getColumna() + "] -> " +  yytext()));
          }
        case 66: break;
        case 29: 
          { return symbol(BOOLEANO, new String("["+ getLinea() + ":" + getColumna() + "] -> " +  yytext()));
          }
        case 67: break;
        case 2: 
          { return symbol(ENTERO, new String("["+ getLinea() + ":" + getColumna() + "] -> " +  yytext()));
          }
        case 68: break;
        case 13: 
        ...
        case 69: break;
        case 34: 
          { return symbol(INT, new String("["+ getLinea() + ":" + getColumna() + "] -> " +  yytext()));
          }
        case 70: break;
        case 22: 
